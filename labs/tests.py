...
def test_check_num_prime(results_dict):
    """
    Checks that lab1.check_num_prime() returns a booeal type
    """
    print("")
    print("Testing check_num_prime()")
    message = "----"
    try:
        result = lab1.check_num_prime(2)
        if not isinstance(result, bool):
            message += 'Did not return a boolean - Fail'
            test_failed(results_dict)
        else:
        ...
        message += 'Could not find lab1.check_num_prime - Fail'
        test_failed(results_dict)
    print(message)

def test_find_factorial(results_dict):
    """
    Checks that lab1.find_factorial() returns an integer type
    """
    print("")
    print("Testing lab1.find_factorial()")
    message = "----"
    try:
        result = lab1.find_factorial(5)
        if not isinstance(result, int):
            message += 'Did not return an integer - Fail'
            test_failed(results_dict)
        else:
        ...
        message += 'Could not find lab1.find_factorial - Fail'
        test_failed(results_dict)
    print(message)
...
def run():
    ...
    test_check_num_prime(results_dict)
    test_find_factorial(results_dict)
    print("")
    print("Final Results:")
